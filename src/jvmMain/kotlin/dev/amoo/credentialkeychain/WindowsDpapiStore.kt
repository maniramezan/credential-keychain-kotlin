...
internal class WindowsDpapiStore(
    ...
    override fun read(key: String): String? {
        ...
        return try {
            ...
            throw KeychainUnavailableException("Windows DPAPI returned invalid data")
        }
    }
    ...
    override fun write(
        ...
        if (!storageDir.isDirectory &&
            ...
            throw KeychainUnavailableException("Windows ciphertext directory cannot be created")
        }
        val file = fileFor(key)
